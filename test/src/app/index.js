QUnit.testSuites([
    /* Full tests for ES modules */
    { name: "simple core Test Suite", path: "./simple-core.html" },
    { name: "simple events Test Suite", path: "./simple-events.html" },
    ...
    { name: "plugin events full Test Suite", path: "./plugin-events-full.html" },
    { name: "plugin forms core Test Suite", path: "./plugin-forms-core.html" },
    { name: "plugin forms full Test Suite", path: "./plugin-forms-full.html" },
    { name: "plugin visible core Test Suite", path: "./plugin-visible-core.html" },
